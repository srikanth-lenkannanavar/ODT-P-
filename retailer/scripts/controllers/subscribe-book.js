 ...
 */
angular.module('app')
  .controller('SubscribeBookCtrl', function ($scope, $rootScope, $location, $modal,restservice, modalservice,$routeParams,$filter,envconfig) {
	  
	  $scope.paymentPage = function(){
    //var formData = '{"user":"'+ $rootScope.loggedUser + '"}';
    //var user = $rootScope.loggedUser;
		  restservice.get(envconfig.get('host')+encodeURI("/bookings/subscription"), '',
