    ...
    var _environments = {
        ...
        uat: {
            config: {
                ...
                home: 'http://ec2-54-154-162-107.eu-west-1.compute.amazonaws.com/app',
                homeNonSsl: 'http://ec2-54-154-162-107.eu-west-1.compute.amazonaws.com/app',
        ...
        dev: {
            config: {
                ...
                home: 'http://ec2-54-77-96-65.eu-west-1.compute.amazonaws.com/app',
                homeNonSsl: 'http://ec2-54-77-96-65.eu-west-1.compute.amazonaws.com/app',
        ...
        prod: {
            config: {
                ...
                home: 'https://www.onthedot.co.uk/app',
                homeNonSsl: 'http://www.onthedot.co.uk/app',
        ...
        sandbox: {
            config: {
                ...
                homeNonSsl: 'http://retailer.onthedot.com/retailer',
                retailerHome: 'https://retailer.onthedot.com/retailer',
                consumerHome: 'https://www.onthedot.co.uk/app',
                appId: '1575137759428947',
                payment: 'https://hpp.realexpayments.com/pay'
